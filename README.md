...
- **`ask-gemini`**: Asks Google Gemini for its perspective. Can be used for general questions or complex analysis of files.
  ...
  - **`model`** (optional): The Gemini model to use. Defaults to `gemini-3-flash-preview`. Available models: `gemini-3-flash-preview`, `gemini-3-flash-pro`, `gemini-2.5-pro`, `gemini-2.5-flash`.
